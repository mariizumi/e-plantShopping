...
function ProductList() {
  ...
  const getAddButtonText = (product) => {
    return cart.find(item => item.name == product.name) ? 'Added to Cart' : 'Add to Cart';
  };

  const isPlantInCart = (product) => cart.find(item => item.name == product.name);
        ...
        <div style={styleObjUl}>
          ...
          <div style={{ position: 'relative' }}>
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <div className="cart-quantity">{getCartItemCount()}</div>
